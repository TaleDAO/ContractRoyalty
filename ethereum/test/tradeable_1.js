...
//        }
        ...
        // 3 readers purchase
//        console.log((await instance.getBalance.call(accounts[7])).toString());
//        console.log((await instance.getBalance.call(accounts[8])).toString());
//        console.log((await instance.getBalance.call(accounts[9])).toString());
        ...
        if (quota8 == 20) {
            ...
            console.log("here1", (await instance.getBalance.call(accounts[8])).toString());
            console.log("here2", (await instance.getBalance.call(accounts[9])).toString());
